...
export const Footer = () => {
     return (
       <section
         className="flex flex-col sm:flex-row w-full bg-[#72d7eb] text-black p-6 
       ...
       >
         ...
         <div className="flex flex-col gap-4 text-center sm:text-left w-full sm:w-auto">
           <h1 className="text-3xl sm:text-4xl font-semibold">Delish</h1>
         ...
         <div className="w-full sm:w-auto mt-5 sm:mt-0">
           <ul
             className="flex flex-wrap justify-center sm:justify-start gap-10 sm:gap-[5vw] md:gap-[7vw]"
           >
